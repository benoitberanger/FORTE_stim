...
diameter   = S.Parameters.Forte.Cursor.DimensionRatio*S.PTB.wRect(4);
diskColor  = S.Parameters.Forte.Cursor.DiskColor;
frameColor  = S.Parameters.Forte.Cursor.FrameColor;
